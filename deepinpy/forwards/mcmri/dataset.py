...
class MultiChannelMRIDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_file, stdev=.01, num_data_sets=None, adjoint_data=True, preload=False, id=None, clear_cache=False, cache_data=False, gen_masks=False, scale_data=False, fully_sampled=False, data_idx=None, inverse_crime=False, noncart=False):
