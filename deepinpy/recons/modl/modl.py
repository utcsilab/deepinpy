...
class MoDLReconOneUnroll(torch.nn.Module):
    ...
    def batch(self, data):
        ...
        self.A = MultiChannelMRI(maps, masks, l2lam=0., img_shape=data['imgs'].shape, use_sigpy=self.args.use_sigpy, use_kbnufft=self.args.use_kbnufft, noncart=self.args.noncart)
